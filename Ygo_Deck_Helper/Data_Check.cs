...
namespace Ygo_Deck_Helper
{
    public class Data_Check
    {
        ...
        public static List<string> card_frequency_parse(List<string> Raw_List, bool isReversed)
        {
            ...
            foreach (string sr in Raw_List)
            {
                ...
                else
                {
                    ...
                    New_Card_Text = Frequency_Name_Data.Key;
                    Card_Count = Frequency_Name_Data.Value;
        ...
        private static KeyValuePair<string, int> Extract_Frequency(string Card_Text, bool isReversed)
        {
            int removeammount = 2;
            ...
            return new KeyValuePair<string, int>(Card_Text, Card_Frequency);
        }
        ...
        internal static KeyValuePair<List<string>, List<string>> Deck_Header_Parse(List<string> Raw_List)
        {
            ...
            return new KeyValuePair<List<string>, List<string>>(Raw_List, Side_Deck_cards);
        }
        ...
        public static KeyValuePair<List<string>, List<string>> Clense_Card_Names(List<string> Card_Names, Format_Settings Current_Settings)
        {
            KeyValuePair<List<string>, List<string>> Unseperated_Card_Names = Deck_Header_Parse(Card_Names);
            List<string> Main_Extra_Card_Names = Unseperated_Card_Names.Key;
            List<string> Side_Card_Names = Unseperated_Card_Names.Value;
            ...
            return new KeyValuePair<List<string>, List<string>>(Main_Extra_Card_Names, Side_Card_Names);
        }
